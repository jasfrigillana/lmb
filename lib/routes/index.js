    ...
    app.post('/register', function(request, response) {
        ...
        connection.query('INSERT INTO address (country, province, city, barangay, street, postal_code) VALUES ("' + country + '", "' + province + '", "' 
            ...
            function (error, results, fields) {
                ...
                connection.query('INSERT INTO user (first_name, middle_name, last_name, nickname, position, organization, email_address, alternate_email_address, address_id) '
                    + 'VALUES ("' + firstName + '", "' + middleName + '", "' + lastName + '", "' + nickname + '", "' + position  + '", "' + organization + '", "' 
                    + emailAddress + '", "' + alternateEmailAddress + '", "' + addressId + '")',
                    function (error, results, fields) {
